...
# Source to reproduce results from @gerard2018empirical
...
evaluations of @gerard2018empirical.
...
To reproduce the results of @gerard2018empirical, you need to (i)
...
To reproduce all of the results in @gerard2018empirical, move to
